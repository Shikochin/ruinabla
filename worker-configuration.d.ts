/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 02654a791f0a9632904c14ea21be49a4)
// Runtime types generated with workerd@1.20251128.0 2024-04-05 nodejs_compat
declare namespace Cloudflare {
  interface Env {
    OPENAI_API_KEY: string
    OPENAI_API_BASE: string
    VITE_RECENT_COMMENTS_PAT: string
    VITE_COMMIT_HASH_PAT: string
